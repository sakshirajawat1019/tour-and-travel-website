...
<div class="login-form-container">
    ...
    <form action="">
        ...
        <input type="submit" value="login now" class="btn" required>
...
<section class="book" id="book">
    ...
    <div class="row">
        ...
        if(isset($_POST['save'])){
            ...
            $sql1 = "INSERT INTO prebook (location,guests,arrivals,leaving) VALUES('{$location}','{$guests}','{$arrivals}','{$leaving}')";
        ...
        <form  action="<?php $_SERVER['PHP_SELF']; ?>" method ="POST" autocomplete="off">
            <div class="inputBox">
                <h3>where to</h3>
                <input type="text" name="location" placeholder="place name">
            </div>
            <div class="inputBox">
                <h3>how many</h3>
            ...
            <input type="submit" name="save" class="btn" value="book now">
        </form>
...
<section class="review" id="review">
    ...
    <a href="addreview.php" class="btn"><b><h1>+ Add Review</h1></b></a>
    <br><br><br><br>
...
<section class="contact" id="contact">
    ...
    <div class="row">
        ...
        if(isset($_POST['csave'])){
            ...
            $sql2 = "INSERT INTO connect (name,email,number,subject,message) VALUES('{$cname}','{$cemail}','{$cnumber}','{$csubject}','{$cmessage}')";
        ...
        <form  action="<?php $_SERVER['PHP_SELF']; ?>" method ="POST" autocomplete="off">
            ...
            <div class="inputBox">
                <input type="number" name="cnumber" placeholder="number">
                <input type="text" name="csubject" placeholder="subject">
            </div>
            <textarea placeholder="message" name="cmessage" id="" cols="30" rows="10"></textarea>
            <input type="submit" class="btn" name="csave" value="send message">
        </form>
